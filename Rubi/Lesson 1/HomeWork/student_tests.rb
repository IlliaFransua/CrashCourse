...
def test_student_initialization
  student = Student.new("Fransua", "Illia", "03-08-2004")
  
  raise "Test failed: Incorrect surname" if !student.surname == "Fransua"
  raise "Test failed: Incorrect name" if !student.name == "Illia"
  raise "Test failed: Incorrect date_of_birth" if student.date_of_birth != {"day" => 3, "month" => 8, "year" => 2004}
...
def test_invalid_date_format
  ...
  begin
    Student.new("Fransua", "Illia", "03/08/2004")
...
def test_future_date_of_birth
  ...
  begin
    Student.new("Fransua", "Illia", "03-08-2025")
...
def test_calculate_age
  ...
  student = Student.new("Fransua", "Illia", "03-08-2004")
  expected_age = Date.today.year - 2004
...
def test_get_students_by_name
  ...
  student = Student.new("Fransua", "Illia", "03-08-2004")
  raise "Test failed: Incorrect students by name" if !Student.get_students_by_name("Illia").include?(student)
