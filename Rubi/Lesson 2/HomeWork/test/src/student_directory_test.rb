...
class StudentDirectoryTest < Minitest::Test
  def setup
    @student1 = Student.new('Ivanenko', 'Ivan', '2000-01-01')
    @student2 = Student.new('Shevchenko', 'Oleg', '1999-12-31')
  ...
  def test_get_students_by_name
    ...
    assert_equal [@student1], @directory.get_students_by_name('Ivan')
    assert_equal [@student2], @directory.get_students_by_name('Oleg')
    assert_empty @directory.get_students_by_name('Illia')
  end
